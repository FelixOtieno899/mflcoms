                    ...
                    <ul>
                        ...
                        >
                            <router-link
                                @click="
                                    (e) =>
                                        handleActiveChangeLocation(e, 'today')
                                "
                                to="#"
                            >
                                Today
                        ...
                        >
                            <router-link
                                @click="
                                    (e) => handleActiveChangeLocation(e, 'week')
                                "
                                to="#"
                            >
                                Week
                        ...
                        >
                            <router-link
                                @click="
                                    (e) =>
                                        handleActiveChangeLocation(e, 'month')
                                "
                                to="#"
                            >
                                Month
...
const SalesByLocation = defineComponent({
    ...
    setup() {
        ...
        const topLocationState = computed(
            () => state.chartContent.locationData,
        );
