...
const Main = Styled.div`
    ...
    .wizard-side-border{
        ...
        .steps-wrapper{
            ...
            ${({ theme }) => (theme.rtl ? "border-right" : "border-left")}: 1px solid ${({
                theme,
...
const TableWrapper = Styled.div`
    ...
    .ninjadash-status{
        ...
        &.ninjadash-status-approved{
            color: ${({ theme }) => theme["success-color"]};
            background-color: ${({ theme }) => theme["success-color"]}15;
        }

        &.ninjadash-status-cancelled{
            color: ${({ theme }) => theme["danger-color"]};
            background-color: ${({ theme }) => theme["danger-color"]}15;
        }

        &.ninjadash-status-delivered{
            color: ${({ theme }) => theme["success-color"]};
            background-color: ${({ theme }) => theme["success-color"]}15;
        }
        ...
        &.ninjadash-status-pending{
            color: ${({ theme }) => theme["warning-color"]};
            background-color: ${({ theme }) => theme["warning-color"]}15;
        }

        &.ninjadash-status-ongoing{
            color: ${({ theme }) => theme["success-color"]};
            background-color: ${({ theme }) => theme["success-color"]}15;
        }

        
        &.ninjadash-status-completed{
            color: ${({ theme }) => theme["success-color"]};
            background-color: ${({ theme }) => theme["success-color"]}15;
        }

        
        &.ninjadash-status-dispatched{
            color: ${({ theme }) => theme["success-color"]};
            background-color: ${({ theme }) => theme["success-color"]}15;
        }

        &.ninjadash-status-paid{
            color: ${({ theme }) => theme["success-color"]};
            background-color: ${({ theme }) => theme["success-color"]}15;
        }


        &.ninjadash-status-unpaid{
            color: ${({ theme }) => theme["warning-color"]};
            background-color: ${({ theme }) => theme["warning-color"]}15;
        }
