                    ...
                    >
                        ...
                        <sdCards class="wrapperCard_order" headless>
                            <div class="ninjadash-review-order__single">
                                <sdCards headless>
                                    <div
                                        class="ninjadash-review-order__shippingTitle"
                                    >
                                        <sdHeading as="h5">
                                    ...
                                    <article
                                        class="ninjadash-review-order__shippingInfo"
                                    >
                                        <a-radio-group
        ...
        const dataSource = computed(() => {
            ...
            return (
                ...
                cartData.value.map((data) => {
                    const { id, img, name, quantity, price, size, color } =
                        data;
                    subtotal.value +=
                        parseInt(quantity, 10) * parseInt(price, 10);
                    return {
                        key: id,
                        product: (
