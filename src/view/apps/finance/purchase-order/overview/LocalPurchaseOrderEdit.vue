    ...
    <sdCards>
        <template v-slot:title>
            <div class="setting-card-title">
                <sdHeading as="h4">Edit Local Purchase Order</sdHeading>
                        ...
                        <div class="invoice-body">
                            ...
                            >
                                ...
                                <sdButton
                                    size="small"
                                    type="danger"
                                    @click.prevent="removeLastLineItem"
                                >
                                    - remove Line Item
                                </sdButton>
                            </div>
...
const LocalPurchaseOrderEdit = defineComponent({
...
export default LocalPurchaseOrderEdit;
</script>
