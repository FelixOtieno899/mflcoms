    ...
    <sdCards>
        <template v-slot:title>
            <div class="setting-card-title">
                <sdHeading as="h4">Fule Dispensation Order Info</sdHeading>
            </div>
        </template>
                ...
                <a-row :gutter="16">
                    <a-col :span="8">
                        <a-form-Item label="Dispense Date">
                            <a-input readonly v-model:value="formState.dispense_date" />
                        </a-form-Item>
                    </a-col>
                    <a-col :span="8">
...
const FuelDispensationOrderView = defineComponent({
    ...
    setup(props) {
        ...
        onMounted(async () => {
           ...
           formState.reference_number = fuelDispensationOrderDetails.purchase_order.reference_number;
            formState.fuel_type =
...
export default FuelDispensationOrderView;
</script>
