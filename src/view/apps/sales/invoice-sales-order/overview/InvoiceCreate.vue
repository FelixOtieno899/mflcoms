                             ...
                             >
                                ...
                                <template #header>
                                    ...
                                    >
                                        ...
                                        >
                                          40FT Count:  {{
                                                getContainerCount(note).fortyFT
                                            }}
                                        </span>
                                        <span
                                            v-if="
            ...
            try {
                ...
                if (
                    ...
                    if (adjustment.value) {
                        ...
                        deliveryNotes.value =
                            response.data.Delivery_notes.filter(
