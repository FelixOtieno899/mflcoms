    ...
    <sdCards>
        <template v-slot:title>
            <div class="setting-card-title">
                <sdHeading as="h4">Vehicle Insurance's Info</sdHeading>
                ...
                <a-row :gutter="16">
                    <a-col :span="12">
                        <a-form-Item label="Policy Number">
                            <a-input
                                v-model:value="formState.policy_number"
                                readonly
                            />
                        </a-form-Item>
                    </a-col>
...
const VehicleInsuranceView = defineComponent({
    ...
    setup(props) {
        ...
        //             `/vehicle/insurance/${vehicleInsurerId}`,
        //             updatedDetails,
        //         );
        //         console.log(
