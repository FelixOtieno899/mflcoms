<template>
    ...
    >
        ...
        <a-sub-menu key="reports">
            <template #icon>
                <unicon name="book"></unicon>
            </template>
            <template #title>{{ t("Report") }}</template>
            <a-menu-item @click="toggleCollapsed" key="income-expense">
                <router-link to="/app/report/income-expense">
                    {{ t("Income Vs Expense") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="account-statement">
                <router-link to="/app/report/account-statement">
                    {{ t("Account Statement") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="fuel-sheet">
                <router-link to="/app/report/fuel-sheet">
                    {{ t("Fuel") }} {{ t("Sheet") }}
                </router-link>
            </a-menu-item>
        </a-sub-menu>
        ...
        <a-sub-menu key="users">
            ...
            <a-menu-item @click="toggleCollapsed" key="user-grid">
                <router-link to="/app/users/roles">
                    {{ t("Roles & Permissions") }}
                </router-link>
            </a-menu-item>
      ...
      <a-menu-item @click="toggleCollapsed" key="dataTable">
        ...
        <a-sub-menu key="note">
            ...
            <template #title>{{ t("Operations") }} </template>
            <a-menu-item @click="toggleCollapsed" key="drivers">
                <router-link to="/app/drivers">
                    {{ t("Drivers") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="vehicles">
                <router-link to="/app/vehicles">
                    {{ t("Vehicles") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="vehicle-insurances">
                <router-link to="/app/vehicle-insurances">
                    {{ t("Vehicle Insurances") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="supplier">
                <router-link to="/app/suppliers">
                    {{ t("Suppliers") }}
                </router-link>
            </a-menu-item>
            ...
            <a-menu-item @click="toggleCollapsed" key="trip">
                <router-link to="/app/trips">
                    {{ t("Trips") }}
                </router-link>
            </a-menu-item>
      ...
      <a-menu-item @click="toggleCollapsed" key="note-important">
        ...
        <a-sub-menu key="blog">
            <template #icon>
                <unicon name="coins"></unicon>
            </template>
            <template #title>{{ t("Sales") }} </template>
            <a-menu-item @click="toggleCollapsed" key="clients">
                <router-link to="/app/clients">
                    {{ t("Clients") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="location">
                <router-link to="/app/client-locations">
                    {{ t("Client Locations") }}
                </router-link>
            </a-menu-item>
            ...
            <a-menu-item @click="toggleCollapsed" key="sales">
                <router-link to="/app/sales-orders">
                    {{ t("Sales Orders") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="delivery-note">
                <router-link to="/app/delivery-note">
                    {{ t("Delivery") }} {{ t("Note") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="credit">
                <router-link to="/app/credit-note">
                    {{ t("Credit") }} {{ t("Note") }}
                </router-link>
            </a-menu-item>
        </a-sub-menu>
        ...
        <a-sub-menu key="ecommerce">
            <template #icon>
                <unicon name="money-stack"></unicon>
            </template>
            <template #title>{{ t("Finance") }}</template>
            <a-menu-item @click="toggleCollapsed" key="account">
                <router-link to="/app/accounts">
                    {{ t("Accounts") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="purchase-order">
                <router-link to="/app/local-purchase-order">
                    {{ t("Purchase") }} {{ t("Order") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="fdispensation-order">
                <router-link to="/app/dispensation-order">
                  {{ t("Dispensation Order") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="dispensation">
                <router-link to="/app/fuel-dispensation">
                    {{ t("Fuel") }} {{ t("Dispensation") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="expense">
                <router-link to="/app/expense">
                    {{ t("Expense") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="bills">
              <router-link to="/app/bills">
                  {{ t("Bills") }}
              </router-link>
          </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="job-card">
                <router-link to="/app/job-card">
                    {{ t("Job Card") }}
                </router-link>
            </a-menu-item>
            <!-- <a-menu-item @click="toggleCollapsed" key="invoice">
        ...
        <a-sub-menu key="learning">
            ...
            <template #title>{{ t("Compliance") }} </template>
            <a-menu-item @click="toggleCollapsed" key="compliant">
                <router-link to="/app/driver-complaint">
                    {{ t("Driver Complaint/Incident") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="driver-achievement">
                <router-link to="/app/driver-achievement">
                    {{ t("Driver") }} {{ t("Achievement") }}
                </router-link>
            </a-menu-item>
        </a-sub-menu>
        ...
        <a-sub-menu key="config">
            ...
            <template #title>{{ t("Configurations") }} </template>

            <a-menu-item @click="toggleCollapsed" key="account-type">
                <router-link to="/app/account-types">
                    {{ t("Account Types") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="vehicle-brands">
                <router-link to="/app/vehicle-brands">
                    {{ t("Vehicle Brands") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="insurers">
                <router-link to="/app/insurers">
                    {{ t("Insurers") }}
                </router-link>
            </a-menu-item>
            <a-menu-item @click="toggleCollapsed" key="vendors">
                <router-link to="/app/vendors">
                    {{ t("Vendors") }}
                </router-link>
            </a-menu-item>

            <a-menu-item @click="toggleCollapsed" key="measurement">
                <router-link to="/app/units-of-measures">
                    {{ t("Units of Measures") }}
                </router-link>
            </a-menu-item>
            <!-- <a-menu-item @click="toggleCollapsed" key="social-note">
