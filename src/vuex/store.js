...
export default createStore({
  ...
  plugins: [
    createPersistedState({
      key: "myapp-state", // Key to identify the persisted state in storage
      storage: window.localStorage, // Choose localStorage or sessionStorage
      paths: null, // Persist the entire Vuex store state
    }),
  ],
});
